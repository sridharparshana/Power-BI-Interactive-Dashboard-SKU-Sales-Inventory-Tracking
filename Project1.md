...
* **Operational Efficiency:** Streamlines the replenishment process by highlighting exactly where stock levels fall below safety thresholds.

## Technical Implementation
* **Data Modeling:** Integrated Sales and Inventory datasets using a star schema.
* **DAX Measures:** Developed custom logic for SKU ranking, stock-to-sales ratios, and conditional formatting alerts.
* **Visualization:** Designed an interactive UI featuring KPIs, trend lines, and SKU-level breakdown tables.

## How to Access
* **PBIX File:** Download the source file to explore the interactive filters and data model.
